...
export default function PerformanceDetail() {
  ...
  // If performance not found, show the not found component
  if (!performance) {
    return <PerformanceNotFound />
  }

  // Get other performances (excluding the current one) for related content
  const otherPerformances = performances.filter(item => item.id !== id);
      ...
      <section className="pt-28 pb-12 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              <FaArrowLeft className="mr-2" /> Voltar às atuações
            </Link>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {otherPerformances.length > 0 ? (
              otherPerformances.slice(0, 3).map((item) => (
                <motion.div
                  key={item.id}
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-400 mb-4 font-['Montserrat',sans-serif] line-clamp-3">
                      {item.summary}
                    </p>
              ...
              <div className="bg-gray-900 rounded-lg p-6 col-span-3 text-center">
                <p className="text-gray-400 font-['Montserrat',sans-serif]">
                  Não existem outras atuações disponíveis no momento.
                </p>
                <Link
                  href="/atuacoes"
